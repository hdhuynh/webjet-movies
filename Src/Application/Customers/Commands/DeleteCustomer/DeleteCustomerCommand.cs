...
namespace Webjet.Application.Customers.Commands.DeleteCustomer;

public record DeleteCustomerCommand(string Id) : IRequest;

// ReSharper disable once UnusedType.Global
public class DeleteCustomerCommandHandler(IWebjetDbContext context) : IRequestHandler<DeleteCustomerCommand>
{
