...
public class WebjetDbContextInitializer(ILogger<WebjetDbContextInitializer> logger, WebjetDbContext dbContext,
    IUserManager userManager)
{
    ...
    private async Task SeedUsersAsync(CancellationToken cancellationToken)
    {
        ...
        if (employees.Any())
        {
            ...
            {
                var userName = $"{employee.FirstName}.{employee.LastName}@webjet".ToLower();
                var userId = await userManager.CreateUserAsync(userName, "Webjet1!");
